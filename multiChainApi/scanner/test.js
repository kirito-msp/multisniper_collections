      ...
      try{
        ...
        const headers = {
          ...
          .then(data => {
            ...
            verified = 'No'
            followers = parseFloat(infoResult.legacy.normal_followers_count).toLocaleString()
...
function timeAgo(dateString) {
  ...
  } else if (secondsDifference < 2592000) { // 30 days approx.
    timeString = `${Math.floor(secondsDifference / 86400)} days`;
  } else if (secondsDifference < 31104000) { // 12 months approx.
